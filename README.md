...
[![LeetCode](https://img.shields.io/badge/LeetCode-20%20Solved-FFA116?style=flat-square&logo=leetcode&logoColor=black)](https://leetcode.com/)
[![Kattis](https://img.shields.io/badge/Kattis-145%20Solved-1F8ACB?style=flat-square)](https://open.kattis.com/)
...
Each solution is written in Python with inline comments explaining the approach. Problems are sourced from LeetCode's daily question feed and a structured list of patterns commonly tested in technical interviews.
...
20 problems solved across 7 topics.
...
Problems are grouped by topic and ordered Easy to Hard within each group.
...
Solutions to 145 problems from [open.kattis.com](https://open.kattis.com), a competitive programming judge. Topics range from simple I/O and string parsing to number theory, simulation, and geometry. Problems span multiple difficulty tiers and include a mix of Icelandic regional contest problems and international challenges.
